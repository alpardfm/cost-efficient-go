// Package main demonstrates JSON processing efficiency patterns.
// This is the educational example code showing the cost-efficiency pattern.
//
// Run with: go run ./patterns/json-processing/examples/
package main
...
// BadResponse is an unoptimized response struct
...
// GoodResponse is an optimized response struct
...
// BadProduct uses map[string]interface{} for known structures
...
// GoodProduct uses typed struct for known fields
